/*
 * Done by Caitlin Fernandez crf59 and Anna Sedlackova axs1202
 * 12 December 2016
...
public class FinalProject {
  ...
  private static String[][] dictionary = new String[10000][2];
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Enter your letters as a string of lowercase characters without spaces or punctuation in it: ");
    String s = scan.next();
    scan.close();
    ...
    for (int i = 0; i < s.length(); i++) {
      ...
      if ((c - '0') < ('a' - '0') || (c - '0') > ('z' - '0')) {
        ...
        System.out.println("Please enter a string of ONLY lowercase characters without spaces or punctuation: ");
        s = scan.next();
        scan.close();
      }
    }
